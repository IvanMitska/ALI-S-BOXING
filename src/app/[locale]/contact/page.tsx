      ...
      <section className="py-16 lg:py-24">
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              {/* Prominent WhatsApp & Instagram buttons */}
              <AnimatedSection>
                <div className="flex flex-wrap gap-3 mb-10">
                  <a
                    ...
                    className="inline-flex items-center gap-3 px-5 py-3 bg-brand-yellow hover:bg-brand-yellow/90 text-black font-semibold rounded-lg transition-all hover:scale-[1.02]"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-3 px-5 py-3 border border-brand-yellow/60 hover:bg-brand-yellow/10 text-white font-semibold rounded-lg transition-all hover:scale-[1.02]"
                  >
